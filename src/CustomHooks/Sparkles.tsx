...
//         {children}
//       </h1>
//       <div className="w-12 h-12 relative border-2">
//         {/* Gradients */}
...
//         <div className="absolute inset-0 w-12 h-12 bg-black [mask-image:radial-gradient(350px_200px_at_top,transparent_20%,white)]"></div>
//       </div>
//     </div>
//   );
// }
